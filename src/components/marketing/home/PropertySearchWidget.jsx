...
export default function PropertySearchWidget({ searchSection }) {
  ...
  const placeholder = activeConfig.placeholder || "Search properties";
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-slate-700/80 bg-slate-950/90 shadow-[0_30px_70px_-40px_rgba(2,6,23,0.95)] backdrop-blur">
      ...
      <div className="bg-slate-900/70 px-3 py-3 sm:px-4">
        <div className="grid grid-cols-1 gap-2 md:grid-cols-[150px_220px_1fr_auto]">
          ...
          <button type="button" className={`h-11 rounded-lg bg-gradient-to-r ${currentTheme.accent} px-6 text-sm font-semibold text-white`}>
            Search
          </button>
        </div>
