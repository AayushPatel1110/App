...
import { getDefaultProductKey, getDefaultProductName, setDefaultProductKey } from "./pro.service";
import { getJsonCookie, getCookie } from "./cookie";
...
const getRefreshProductKeyCandidates = () => {
  ...
  return [...new Set([preferred, "property", "seaneb"].filter(Boolean))];
};
...
export const refreshAccessToken = async () => {
  ...
  if (!csrf) {
    csrf = getCookie("csrf_token") || getCookie("csrf-token");
