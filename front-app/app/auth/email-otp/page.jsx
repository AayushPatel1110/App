...
// Services
import { verifyEmailOtp, sendEmailOtp } from "@/services/email.service"
import { getJsonCookie, setCookie, setJsonCookie, removeCookie, getCookie } from "@/services/cookie"
...
function EmailOtpContent() {
  ...
  useEffect(() => {
    // Get email from URL params or from cookie context
    ...
    if (urlPurpose) {
      setOtpPurpose(Number(urlPurpose) || 1)
    }

    const nextRedirect = urlRedirect || ctx?.redirect_to || "/auth/complete-profile"
